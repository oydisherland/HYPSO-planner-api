...
#Time Window
TW = namedtuple("TW", ["start", "end", "cloudCoverage"])
...
def generateTaskID(gtName: str, startTime: float) -> int:
    ...
    Args:
        ...
        startTime (float): The start time of the observation task in seconds relative to the start of the planning horizon.
